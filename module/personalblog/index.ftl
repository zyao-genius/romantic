<div class="whitebg bloglist">
    ...
    <ul>
        ...
        <li>
            ...
            <p class="bloginfo"><i class="avatar"><img src="${user.avatar!}"></i><span>杨青青</span><span>2018-10-28</span><span>【<a href="/">原创模板</a>】</span></p>
        <li>
            ...
            <p class="bloginfo"><i class="avatar"><img src="${user.avatar!}"></i><span>杨青青</span><span>2018-10-28</span><span>【<a href="/">最新模板</a>】</span></p>
        <li>
            ...
            <p class="bloginfo"><i class="avatar"><img src="${user.avatar!}"></i><span>杨青青</span><span>2018-10-28</span><span>【<a href="/">快速建站</a>】</span></p>
        <li>
            ...
            <p class="bloginfo"><i class="avatar"><img src="${user.avatar!}"></i><span>杨青青</span><span>2018-10-28</span><span>【<a href="/">设计制作</a>】</span></p>
        <!--纯文字-->
        <li>
