...
function loadModel(modelId, modelTexturesId=0) {
    ...
    }loadlive2d('live2d', live2d_settings.modelAPI, (live2d_settings.showF12Status ? console.log('[Status]','live2d','模型',modelId+'-'+modelTexturesId,'加载完成'):null));
}
